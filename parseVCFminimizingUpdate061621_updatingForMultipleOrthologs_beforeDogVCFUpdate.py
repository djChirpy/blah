...
'''
add in rounding of trinucleotide context to two digits (ex. 0.56 rather than 0.5556) to see if that makes a difference
'''
'''
currently rejecting anything on chrM due to uncertainty around trinucleotide and inclusion in other studies
'''
...
'''
to add:
/seq/vgb/cancer_r01/cbioportal/pediatric_columbia_2019/mixed_pipseq_2017/ x
/seq/vgb/cancer_r01/cbioportal/metastatic_solid_umich_2017/metastatic_solid_tumors_mich_2017/data_mutations_mskcc.txt x

/seq/vgb/cancer_r01/icgc/release_28/simple_somatic_mutation_files x

/seq/vgb/cancer_r01/cbioportal/metastatic_breast_cancer/MBCP_provisional_feb_2020/brca_mbcproject_wagle_2017/data_mutations_mskcc.txt
/seq/vgb/cancer_r01/cbioportal/metastatic_prostate_cancer/MPCP_provisional_nov_2019/prad_mpcproject_2018/data_mutations_mskcc.txt

092321 Add Kate's melanoma (? maybe) theoretical sample ids, since we haven't heard back from study creators - removing

add in maja's mammary tumor stuff

Double check granularity before re-running for the final version
'''
...
parser.add_argument('-r', '--refFile', default = '/seq/vgb/swofford/dogHumanOrthologs/orthologsCombined020122.bed')
...
class sample:
    def __init__(self, variants, name, species, label = 'NA', assembly = 'NA'):
        pathBrokenInSample = {}
        genesBrokenInSample = {}
        ####
        variantSet = set()
...
class variant:
    ...
    def __init__(self, Effect_Impact = 'NA', Functional_Class = 'NA', Codon_change = 'NA', Amino_Acid_Change = 'NA', 
                 ...
                 Transcript_ID = 'NA', Exon_Rank = 'NA', Genotype = 'NA', Effect = 'NA', chrom = 'NA', pos = 'NA', ref = 'NA', assembly='NA', changeTri='NA'):
        ...
        if len(ref) == 1 and len(Genotype) == 1 and ref != '-' and Genotype != '-':
            ...
            #self.tryWrite = refTrinucleotide[:1] + ref + Genotype + refTrinucleotide[2:]    
